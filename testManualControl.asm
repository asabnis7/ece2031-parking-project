...
SetupPark:
	LOADI 376
	STORE AutoFdist ; Desired forward dist
	LOADI 250
	STORE AutoFvel ; Desired forward velocity
	CALL AutoForward
	CALL Turn_90CW_AUTO
	LOADI 860
	STORE AutoFdist
