...
; ===============[STOP STATE]===============
;	NEUTRAL STATE IN WHICH BOT IS IN PLACE.
;	WAITS FOR IR USER INPUT AND ACTS ACCORDINGLY.
Stop:
	LOADI 0
	STORE DVel
	CALL WaitForIR
...
Spot1:
	LOADI 840
	STORE SpaceDist 	; Segmented distance
	LOADI 3
	STORE FIterations	; Required number of iterations
						; to travel total distance
	CALL AutomaticMode
	JUMP Next
...
WaitRemote:
	...
	SUB	   RB1		   ; Subtract button 1 hex value
	JNEG   WaitRemote
	JPOS   WaitRemote
	;OUT    IR_LO
	RETURN
...
;***************************************************************
;* Turn_5CW
;  Function to turn the robot 5 degrees clockwise
;***************************************************************
Turn_5CW:   
    LOAD Zero
	OUT RESETPOS
...
;***************************************************************
;* Turn_5CCW
;  Function to turn the robot 5 degrees counter-clockwise
;***************************************************************	
Turn_5CCW:
	LOAD Zero
	OUT RESETPOS
...
;=======================================================================
; FUNCTIONS FOR AUTO PARKING


;***************************************************************
;* Turn_90CW_AUTO
;  Function to turn the robot 90 degrees clockwise
;  Use with CALL & RETURN
;***************************************************************
Turn_90CW_AUTO:   
    LOAD Zero
	OUT RESETPOS
...
; REMOTE BUTTONS
RBprev:	  DW &H42BD	   ; Park parallel
RBmute:	  DW &H906F	   ; Park perpendicular
RB1:		  DW &H20DF	   ; Park in space 1
RB2:		  DW &HA05F	   ; Park in space 2
RB3:		  DW &H609F	   ; Park in space 3
RB4:		  DW &HE01F	   ; Park in space 4
RB5:		  DW &H30CF	   ; Park in space 5
RB6:		  DW &HB04F	   ; Park in space 6
RB7:		  DW &H708F	   ; Park in space 7
RB0:		  DW &HB847   ; Turn 90 deg right
RBenter:	  DW &H3AC5	   ; Turn 90 deg left
RBrew:	  	DW &H48B7	   ; Turn 5 deg left
RBff:	   	DW &HC837	   ; Turn 5 deg right
RBplay:	  	DW &H28D7	   ; Forward
RBpause:	DW &H8877	   ; Reverse
RBstop:	  	DW &H08F7	   ; Stop
